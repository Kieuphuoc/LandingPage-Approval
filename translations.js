...
const translations = {
    vi: {
        ...
        hero: {
            ...
            appStatus: "Hồ sơ HR",
            docHeader: "HỢP ĐỒNG LAO ĐỘNG",
            signatureLabel: "Chữ ký người lao động",
            signButton: "Xác nhận ký hợp đồng",
            badgeEkyc: "eKYC xác thực",
            badgeContract: "HĐLĐ hợp lệ"
        },

        // Trusted By Section
        trustedBy: {
            title: "3000+ doanh nghiệp đã lựa chọn ARITO"
        },
        ...
        features: {
            badge: "Tính năng",
            title: "Công cụ quản lý hồ sơ nhân sự chuyên nghiệp",
        ...
        socialProof: {
            badge: "Khách hàng",
            title: "Được doanh nghiệp Việt Nam tin dùng",
            stats: [
                { number: "500+", label: "Doanh nghiệp sử dụng" },
                { number: "50,000+", label: "Hợp đồng lao động đã xử lý" },
                { number: "80%", label: "Giảm thời gian xử lý" },
                { number: "24/7", label: "Hỗ trợ kỹ thuật" }
            ],
            successTitle: "Doanh nghiệp đã triển khai thành công cùng ARITO",
            testimonials: [
                {
                    quote: "Giảm mạnh thời gian xử lý hợp đồng lao động. Trước đây mất 3-5 ngày để ký xong HĐLĐ với ứng viên ở tỉnh, giờ chỉ còn vài giờ.",
                    author: "HR Manager",
                    company: "Công ty [Placeholder]",
                    avatar: "TH"
                },
                {
                    quote: "Quản lý hồ sơ nhân sự tập trung, rõ ràng. Không còn lo thất lạc hợp đồng hay quên gia hạn HĐLĐ như trước.",
                    author: "Head of People",
                    company: "Công ty [Placeholder]",
                    avatar: "NL"
                },
                {
                    quote: "Onboarding nhân sự nhanh hơn nhiều. Ứng viên ký offer, ký HĐLĐ ngay trên điện thoại, không cần đến văn phòng.",
        ...
        // Footer Section
        footer: {
            brandDesc: "Nền tảng quản lý hợp đồng lao động & hồ sơ nhân sự hàng đầu Việt Nam. An toàn, tuân thủ pháp luật, tiện lợi.",
            productTitle: "Sản phẩm",
            productFeatures: "Tính năng",
            productPricing: "Bảng giá",
            productIntegration: "Tích hợp HRM/ERP",
            supportTitle: "Hỗ trợ",
    ...
    en: {
        ...
        hero: {
            ...
            appStatus: "HR Records",
            docHeader: "LABOR CONTRACT",
            signatureLabel: "Employee Signature",
            signButton: "Confirm Contract Signing",
            badgeEkyc: "eKYC Verified",
            badgeContract: "Valid Contract"
        },

        // Trusted By Section
        trustedBy: {
            title: "3000+ businesses trust ARITO"
        },
        ...
        socialProof: {
            badge: "Customers",
            title: "Trusted by Vietnamese Enterprises",
            stats: [
                { number: "500+", label: "Businesses Using" },
                { number: "50,000+", label: "Labor Contracts Processed" },
                { number: "80%", label: "Processing Time Reduced" },
                { number: "24/7", label: "Technical Support" }
            ],
            successTitle: "Businesses Successfully Deployed with ARITO",
            testimonials: [
                {
                    quote: "Significantly reduced labor contract processing time. Previously took 3-5 days to sign contracts with provincial candidates, now only takes a few hours.",
                    author: "HR Manager",
                    company: "Company [Placeholder]",
                    avatar: "TH"
                },
                {
                    quote: "Centralized, clear HR record management. No more worries about lost contracts or forgotten contract renewals.",
                    author: "Head of People",
                    company: "Company [Placeholder]",
                    avatar: "NL"
                },
                {
                    quote: "Much faster employee onboarding. Candidates sign offers and contracts right on their phones, no need to come to the office.",
                    author: "Operations Manager",
                    company: "Company [Placeholder]",
                    avatar: "MT"
                }
        ...
        // Final CTA Section
        finalCta: {
            title: "Ready to digitize labor contract management?",
        ...
        // Footer Section
        footer: {
            brandDesc: "Vietnam's leading labor contract & HR document management platform. Secure, compliant, convenient.",
            productTitle: "Products",
            productFeatures: "Features",
            productPricing: "Pricing",
            productIntegration: "HRM/ERP Integration",
